...
/********************************************************************20**
     ...
     Sid:      cm_os.c@@/main/11 - Thu Jun 24 15:09:18 2010
...
/* cm_os_c_001.main_12 : warning fix */
...
#endif
{
   TRC2(osGets)
   /* cm_os_c_001.main_12 : warning fix */
   RETVALUE(fgets(buf,maxBufLen,stdin));
} /* end of osGets */

/*
*
...
#endif
{
   ...
   if (errno != 0)
   {
      /* cm_os_c_001.main_12 : removed sprintf */
...
#endif
{
   ...
   *id = msgget(key, PERMS|IPC_CREAT|IPC_EXCL);
   ...
   if (!MsgInit)                   /* we only need to do this once */
   {
      ...
      /* cm_os_c_001.main_12 :Fixed warning */      
...
#endif
{
   ...
   RETVALUE((void*)mmap((caddr_t)addr, (size_t) len, (int) prot, (int) flags, 
...
/********************************************************************30**
         ...
         End of file:     cm_os.c@@/main/11 - Thu Jun 24 15:09:18 2010
...
/main/13         --- cm_os_c_001.main_12      sm        1. Including MSPD header file for 4GMX
                                              avenugop  1. Excluding some header files for 4GMX 
											            2. Added Compilation warning fixes
*********************************************************************91*/
