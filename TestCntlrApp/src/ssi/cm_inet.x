...
/********************************************************************20**
        ...
        Sid:      cm_inet.x@@/main/32 - Tue Dec 10 11:43:59 2013
...
/*cm_inet_x_001.main_31: Poll related changes*/
EXTERN S16 cmInetPollRetrieveIdx ARGS((CmInetPollFd  *pollFdArr, U16 eventMask, S16  startIdx));
EXTERN S16 cmInetGetPollFdIdx ARGS((CmInetPollFd  *pollFdArr, CmInetFdType fd));
...
/********************************************************************30**
         ...
         End of file:     cm_inet.x@@/main/32 - Tue Dec 10 11:43:59 2013
...
/main/32     ---      cm_inet_x_001.main_31 mladdha  1. Added poll related changes.
*********************************************************************91*/
