...
typedef struct _fwNbS1HoRequired {
  U32 ueId;
  FwS1HoEvents s1HoEvent;
} FwNbS1HoRequired_t;

typedef struct _fwNbS1HoReqInd {
  U32 ueId;
  U32 currEnbId;
  U32 hoSrcEnbId;
  U32 hoTgtEnbId;
...
typedef struct _fwNbS1HoCmdInd {
  U32 ueId;
  U32 currEnbId;
  U32 hoSrcEnbId;
  U32 hoTgtEnbId;
...
typedef struct _fwNbS1HoCmdDropInd {
  U32 ueId;
  U32 currEnbId;
  U32 hoSrcEnbId;
  U32 hoTgtEnbId;
} FwNbS1HoCmdDropInd_t;

typedef struct _fwNbS1HoPrepFailInd {
  U32 ueId;
  U32 currEnbId;
  U32 hoSrcEnbId;
  U32 hoTgtEnbId;
} FwNbS1HoPrepFailInd_t;

typedef struct _fwNbS1HoCancelAckInd {
  U32 ueId;
  U32 currEnbId;
} FwNbS1HoCancelAckInd_t;

typedef struct _fwNbMmeStatusTrnsfrInd {
  U32 ueId;
  U32 currEnbId;
  U32 hoSrcEnbId;
  U32 hoTgtEnbId;
